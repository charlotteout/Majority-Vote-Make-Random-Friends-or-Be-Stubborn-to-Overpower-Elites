from stabilization_time_exp.simulation_stab import simulation_stab
...
def bigsimulation_stab(graph_loc, type_graph, def_ratio, edge_constant_mult):
    ...
    for init_dens in [0,0.1,0.2,0.3,0.4,0.45,0.472,0.5,0.525,0.55,0.6,0.7,0.8,0.9,1]:
        final_dens = simulation_stab(our_graph=our_graph, honest=True, initial_prob_dens=init_dens, def_ratio=def_ratio)
